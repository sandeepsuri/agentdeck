...
/** Shared by every Repository/Profile/collaborator checkbox list across CollaboratorsPanel.tsx and ProfilesPanel.tsx — toggles one id's membership in an array. */
